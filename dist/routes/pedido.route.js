...
var getPedidoQuery = function (req) {
    ...
    if (req.query.productoSolicitados != null) {
        query.productoSolicitados = Array(req.query.productoSolicitados);
    }
    if (req.query.comprador != null) {
        query.comprador = (req.query.comprador);
    }
    return query;
};
...
pedidoRoutes.post('', function (req, resp) {
    ...
    pedido_model_1.Pedido.create(pedido)
        .then(function (pedidoDB) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, resp.json({ ok: true, mensaje: pedidoDB })];
    }); }); })
        .catch(function (err) { return resp.json({ ok: false, mensaje: err }); });
});
